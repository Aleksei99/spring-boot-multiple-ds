...
import com.javatechie.multiple.ds.api.book.repository.JuleVerneRepository;
...
public class SpringBootMultipleDsApplication {
	...
	@Autowired
	private JuleVerneRepository JVRepository;
	...
	public void addData2DB() {
		...
		JVRepository.saveAll(Stream.of(new JuleVerne(1,"10000 Under Water"),new JuleVerne(2,"Cap Nemo")).collect(Collectors.toList()));
	}
